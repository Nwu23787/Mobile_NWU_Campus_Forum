                    ...
                    <div v-for="(like,index) in state.likeList" :key="like.id" class="item van-hairline--bottom">
                        <div class="top-container">
                            <div class="left-layout">
                                ...
                                <div class="topicTag" v-if="like.module == 10">话题</div>
                                <div class="topicTag" v-if="like.module == 20">评论</div>
                                <div class="topicTag" v-if="like.module == 30">评论回复</div>
                                <div class="topicTag" v-if="like.module == 40">问题</div>
                                <div class="topicTag" v-if="like.module == 50">答案</div>
                                <div class="topicTag" v-if="like.module == 60">答案回复</div>
                            </div>
