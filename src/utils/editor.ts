 ...
 */
export function createEditor(editorToolbarRef:any,editorTextRef:any, menus:Array<string>,emojiPath:string, uploadPath:string, userGradeList:Array<UserGrade> | null,fileStorageSystem:number,toggleEditorCcallback:(id: string) => void,mentionCallback:(id: string) => void) {
